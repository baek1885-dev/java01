...
public class Application01 {
    ...
    public static void main(String[] args) {
         ...
         *   아는 데이터를 우리가 영구적으로 보존하거나, 외부의 데이터를 활용할 때 필수적이다.
         *   파일작업은 외부 자원에 의존을 한다.
         *   파일이 없거나 권한 부적하거나. 이름이 잘못되거나 기타 등등의 예외 상황이
         *   자주 발생한다. */
...

        {
            try {
                ...
                //try 구문에서 버퍼를 생성하면 finally 구문에서 버퍼를 닫아줘야함. 이건 다음 시간에 설명
