...
public class Application01 {
    public static void main(String[] args) {
        ...
        *   2. 각각의 변수는 규칙이 없기 떄문에 반복문을 통한 연속 처리가 불가능하다.
        *   -------------------------
        *   배열의 사용 방법
        ...
        *   0이라는 값이 출력 되었다.
        *   그렇다는 것은 각 자료형 별 기본값으로 세팅이 된다라는 것이다.
        *   ---
        *   정수 : 0
        *   실수 : 0.0
        *   논리 : false
       ...
       //초기값을 0 세팅하는 이유는? 배열은 0부터 시작하는 인덱스 번호 체계를 갖는다.
       ...
       String[] sarr = new String[5];
        for(int i = 0; i<sarr.length;i++){
            System.out.println("sarr2[" + i + "] 공간의 값: " + sarr[i]);
        }
