...
public class Application01 {
    public static void main(String[] args) {
        ...
        int num1 = 1;
        int num2 = 2;
        System.out.println("1번째 :" + num1 + num2);

        int num3 = 5;
        int num4 = 6;
        System.out.println("2번째 :" + num3 + num4);

        // 이제 2개의 수를 더하고 싶을 때마다 위에 3 줄의 코드가
        // 무한히 반복 될 것이다.
        ...
        System.out.println("1 번째 연산 : " + app.sumTwoNumber(100,200));
        System.out.println("2 번째 연산 : " + app.sumTwoNumber(10,230));
        System.out.println("3 번째 연산 : " + app.sumTwoNumber(15,2));
    }
    ...
    * 유지보수를 용이하게 한다.
    *
    * 형식 : [접근제어자] [반환 타입] 메소드명([매개변수 타입 매개변수 명]){
    * 실행할 코드
    * return 반환값; // 반환값이 있다면
    * }
    *
