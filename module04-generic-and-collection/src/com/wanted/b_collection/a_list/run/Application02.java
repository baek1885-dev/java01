...
public static void main(String[] args) {
    ...
    bookList.add(new BookDTO(1, "홍길서전", "승재", 500));
    bookList.add(new BookDTO(2, "한국동전", "씅재", 500000));
    bookList.add(new BookDTO(3, "청길동전", "승자군", 500000));
    bookList.add(new BookDTO(4, "홍길은전", "백승재", 500000));
    bookList.add(new BookDTO(5, "홍길동후", "재", 50000000));
