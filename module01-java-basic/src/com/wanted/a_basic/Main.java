...
public class Main {
  ...
  /*
  * JAVA의 기본 구조 및 실행 방식
  * 모둔 Java  기반의 프로그램은 클래스 안에서 동작한다!!!
  ...
  *
  * 주요 개념
  * - 컴파일(Compile) : .java -> .class 변환(jvm 이 이해할 수 있도록)
  * - 바이트코드(ByteCode) : JVM에서 실행 가능한 중간 코드
  * - JVM : 바이트 코드를 OS 에 맞는 기계어로 변환하여 살행
  *
  * */

    public static void main(String[] args) {

        System.out.println("프로그래밍 세상에 온 것을 환영합니다.");
        System.out.println("코딩 싫어");
    }
