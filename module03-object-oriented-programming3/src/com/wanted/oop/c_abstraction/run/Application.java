...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   객체를 설계하기 위해서는 복잡한 현실 세계를 그대로 반영하기에는
        ...
        *   4. 자동차가 달리고 있는 중이며 브레이크를 밟을 시 시속이 0으로 떨어지며 멈춘다.
        *   5. 브레이크를 밟을 때 자동차가 달리고 있는 중이 아니라면 이미 멈춰있는 상태라고 안내한다.
        ...
        *   4. 시동을 꺼라 */
        ...
        // Application 에서 CarRacer 한테 명령을 내릴 것이다.
        CarRacer racer = new CarRacer();

        // 콘솔 게임을 만들어서 사용자 입력을 전달받기 위해 Scanner 객체 선언
